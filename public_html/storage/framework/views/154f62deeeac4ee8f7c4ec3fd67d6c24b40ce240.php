<?php $__env->startSection('title', 'Our Shop-CraftsManNepal-Cheapest With Best-Handicraft Manufacturer & Wholesale Supplier'); ?>
        ...
        <div class="section learts-mt-70">
            <div class="container">
                <div class="row learts-mb-n50">
                    <div class="col-lg-9 col-12 learts-mb-50 order-lg-2">
                        ...
                        <div id="shop-products" class="products isotope-grid row row-cols-xl-4 row-cols-md-3 row-cols-sm-2 row-cols-1">
                            ...
                            <?php else: ?>
                                <?php $__currentLoopData = $all_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($pro->best_selling == 1 && $pro->new_arrival == 0): ?>
                ...
                background: linear-gradient(90deg, rgba(82,142,85,1) 0%, rgba(11,225,136,1) 100%, rgba(16,219,134,1) 100%);"><i class="fas fa-star-exclamation"></i></span>
                                    ...
                                    <?php elseif($pro->new_arrival == 1 && $pro->best_selling == 0): ?>
                ...
                background: linear-gradient(90deg, rgba(82,142,85,1) 0%, rgba(11,225,136,1) 100%, rgba(16,219,134,1) 100%);"><i class="fas fa-star-exclamation"></i></span>
                                    ...
                                    <?php elseif($pro->new_arrival == 1 && $pro->best_selling == 1): ?>
                                        <div class="grid-item col featured new">
                                                <div class="product">
                                                    <div class="product-thumb">
                                    <span class="product-badges">
                                        <?php if($pro->discount_price == NULL): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/craftsma/domains/craftsmannepal.com/public_html/resources/views/pages/shop.blade.php ENDPATH**/ ?>