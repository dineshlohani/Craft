                ...
                <form method="POST" action="<?php echo e(route('admin.update.user')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-layout">
                        <div class="row mg-b-25">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="name"  placeholder="Enter User Name" required="" value="<?php echo e($user->name); ?>">
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label">Phone: <span class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="phone"  placeholder="Enter Phone Number" required="" value="<?php echo e($user->phone); ?>">
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label">Email: <span class="tx-danger">*</span></label>
                                    <input class="form-control" type="email" name="email"  placeholder="Enter Email Address" required="" value="<?php echo e($user->email); ?>">
                                </div>
                            </div><!-- col-4 -->
                        </div><!-- row -->
                        <hr><br>
                        ...
                        <div class="form-layout-footer">
                            ...
                            <a href="<?php echo e(route('admin.all.user')); ?>" class="btn btn-danger mg-r-5">Cancel</a>
...
<?php echo $__env->make('admin.admin_layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/craftsma/domains/craftsmannepal.com/public_html/resources/views/admin/user_role/edituser_role.blade.php ENDPATH**/ ?>