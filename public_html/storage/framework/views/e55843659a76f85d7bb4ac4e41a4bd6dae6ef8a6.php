<?php $__env->startSection('title', $item. '-CraftsManNepal-Cheapest With Best-Handicraft Manufacturer & Wholesale Supplier'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="section section-padding pt-0">
        ...
        <div class="shop-toolbar border-bottom">
            <div class="container">
                <h2>Search Results for <?php echo e($item); ?></h2>
                <hr>
            ...
            <div class="container">
                <div class="row learts-mb-n50">
                    <div class="col-lg-9 col-12 learts-mb-50 order-lg-2">
                        ...
                        <div id="shop-products" class="products isotope-grid row row-cols-xl-4 row-cols-md-3 row-cols-sm-2 row-cols-1">
                            ...
                            <?php if($search_products->isEmpty()): ?>
                            ...
                            <?php else: ?>
                                <?php $__currentLoopData = $search_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                background: linear-gradient(90deg, rgba(82,142,85,1) 0%, rgba(11,225,136,1) 100%, rgba(16,219,134,1) 100%);"><i class="fas fa-star-exclamation"></i></span>
                        ...
                        <div class="text-center learts-mt-70">
                            <?php echo e($search_products->links()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/craftsma/domains/craftsmannepal.com/public_html/resources/views/pages/search.blade.php ENDPATH**/ ?>