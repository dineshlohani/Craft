<?php $__env->startSection('title',  $name->subcategory_name . '-CraftsManNepal-Cheapest With Best-Handicraft Manufacturer & Wholesale Supplier'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="section section-padding pt-0">
        ...
        <div class="shop-toolbar border-bottom">
            <div class="container">
                <h2><?php echo e($name->subcategory_name); ?></h2>
                <hr>
                ...
                <div class="row learts-mb-n50">
                    <div class="col-lg-9 col-12 learts-mb-50 order-lg-2">
                        ...
                        <div id="shop-products" class="products isotope-grid row row-cols-xl-4 row-cols-md-3 row-cols-sm-2 row-cols-1">
                            ...
                            <?php else: ?>
                            <?php $__currentLoopData = $sub_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/craftsma/domains/craftsmannepal.com/public_html/resources/views/pages/subcat_products.blade.php ENDPATH**/ ?>