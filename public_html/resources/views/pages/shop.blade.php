...
@section('title', 'Our Shop-CraftsManNepal-Cheapest With Best-Handicraft Manufacturer & Wholesale Supplier')
        ...
        <div class="section learts-mt-70">
            <div class="container">
                        ...
                        <div id="shop-products" class="products isotope-grid row row-cols-xl-4 row-cols-md-3 row-cols-sm-2 row-cols-1">
                            ...
                            @else
                                @foreach($all_products as $pro)
                                    @if($pro->best_selling == 1 && $pro->new_arrival == 0)
                ...
                background: linear-gradient(90deg, rgba(82,142,85,1) 0%, rgba(11,225,136,1) 100%, rgba(16,219,134,1) 100%);"><i class="fas fa-star-exclamation"></i></span>
                                    ...
                                    @elseif($pro->new_arrival == 1 && $pro->best_selling == 0)
                ...
                background: linear-gradient(90deg, rgba(82,142,85,1) 0%, rgba(11,225,136,1) 100%, rgba(16,219,134,1) 100%);"><i class="fas fa-star-exclamation"></i></span>
                                    ...
                                    @elseif($pro->new_arrival == 1 && $pro->best_selling == 1)
