...
@section('title', 'Payment Information-CraftsManNepal-Cheapest With Best-Handicraft Manufacturer & Wholesale Supplier')
...
{{--                                <a href="{{ route('coupon.remove') }}" class="btn btn-danger btn-sm" style="padding: 0;">Remove</a>--}}
                            </th>
                        ...
                        <div class="col-md-12 col-12 learts-mb-30">
                            ...
                            <div class="form-group">
                                <ul style="list-style: none;">
                                    <li><input type="radio" name="payment" value="stripe" style="cursor: pointer;"><img src="{{ asset('public/frontend/assets/images/others/stripe.png') }}" style="width: 120px; height: 80px;"></li>
                                    <li><input type="radio" name="payment" value="paypal" style="cursor: pointer;"><img src="{{ asset('public/frontend/assets/images/others/paypal.png') }}" style="width: 120px; height: 80px;"></li>
                                </ul>
                            </div>
                        </div>
                    </div>
