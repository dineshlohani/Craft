...
@section('title', 'Contact Us-CraftsManNepal-Cheapest With Best-Handicraft Manufacturer & Wholesale Supplier')
        ...
        <div class="row learts-mb-n30">
            <div class="col-lg-4 col-md-6 col-12 learts-mb-30">
                <div class="contact-info">
                    ...
                    <span class="info"><i class="icon fal fa-map-marker-alt"></i> {{ $setting->address }}</span>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12 learts-mb-30">
                <div class="contact-info">
                    <h4 class="title">CONTACT</h4>
                    <span class="info"><i class="icon fal fa-phone-alt"></i> Phone: {{ $setting->phone }}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $setting->phone1 }}</span>
                    <span class="info"><i class="icon fal fa-envelope"></i> Mail: <a>{{ $setting->email }}</a></span>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12 learts-mb-30">
                <div class="contact-info">
        ...
        <div class="row">
            <div class="col-lg-8 col-12 mx-auto">
                <div class="contact-form">
                    <form action="{{route('store.message')}}" method="post">@csrf
                        <div class="row learts-mb-n30">
