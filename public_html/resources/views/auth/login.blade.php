...
@section('title', 'LogIn/SignUp-CraftsManNepal-Cheapest With Best-Handicraft Manufacturer & Wholesale Supplier')
                        ...
                        <form action="{{ route('login') }}" method="POST">@csrf
                            <div class="row learts-mb-n50">
                                <div class="col-12 learts-mb-50">
                                    <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required placeholder="Email address / Phone Number">
                                    @error('email')
                                ...
                                <div class="col-12 learts-mb-50">
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Password" required></div>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row learts-mb-n20">
                                        <div class="col-12 learts-mb-20">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="rememberMe" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
                                                <label class="form-check-label" for="rememberMe">Remember me</label>
                                            </div>
                                        </div>
                                        <div class="col-12 learts-mb-20">
                                            <a href="{{ route('password.request') }}" class="fw-400">Lost your password?</a>
                                        </div>
{{--                                        <a href="{{ url('/auth/redirect/facebook') }}" class="social-button" id="facebook-connect"> <span>Connect with Facebook</span></a>--}}
                                        <a href="{{ url('/auth/redirect/google') }}" class="social-button" id="google-connect"> <span>Connect with Google</span></a>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <form action="{{route('register')}}" method="POST">@csrf
                            <div class="row learts-mb-n50">
                                ...
                                <div class="col-12 learts-mb-20">
                                    ...
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required placeholder="Enter your Phone Number">
                                    @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-12 learts-mb-20">
                                    ...
                                    <input type="email" id="register_email" class="form-control @error('register_email') is-invalid @enderror" name="register_email" value="{{ old('register_email') }}" required placeholder="Enter your E-mail Address">
                                ...
                                <div class="col-12 learts-mb-20">
                                    ...
                                    <input type="password" id="register_password" class="form-control @error('register_password') is-invalid @enderror" name="register_password" required placeholder="Enter your Password">
