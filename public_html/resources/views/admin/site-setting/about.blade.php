                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="about_title" value="{{ $about->about_title }}" required>
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label">About Description: <span class="tx-danger">*</span></label>
                                    <textarea class="form-control" id="summernote" name="about_desc" required>{{ $about->about_desc }}</textarea>
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-4 mb-5">
                                <div class="form-group">
                                    ...
                                    <label class="custom-file">
                                        ...
                                        <img src="{{ URL::to($about->about_image) }}" style="width: 150px; height: 100px; margin-top: 15px; margin-bottom: 10px;">
                            ...
                            <div class="col-lg-12 mt-5`">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" type="text" name="ship_info" required>{{ $about->ship_info }}</textarea>
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label">Return Information: <span class="tx-danger">*</span></label>
                                    <textarea class="form-control" type="text" name="return_info" required>{{ $about->return_info }}</textarea>
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label">Quality Information: <span class="tx-danger">*</span></label>
                                    <textarea class="form-control" type="text" name="quality_info" required>{{ $about->quality_info }}</textarea>
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label">Wrapping Information: <span class="tx-danger">*</span></label>
                                    <textarea class="form-control" type="text" name="wrapping_info" required>{{ $about->wrapping_info }}</textarea>
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <label class="custom-file">
                                        ...
                                        <span class="custom-file-control"></span>
                                        <img class="mb-5 mt-3" src="{{ URL::to($about->video_link_image) }}" style="width: 150px; height: 100px;">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="video_link" value="{{ $about->video_link }}" required>
                                </div>
                            </div><!-- col-4 -->
