    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <span class="breadcrumb-item active">
                @if(Request::is('admin/report/today/order/new'))
                    Today New Orders Report
                @elseif(Request::is('admin/report/today/order/accepted'))
                    Today Accepted Orders Report
                @elseif(Request::is('admin/report/today/order/on-delivery'))
                    Today Order In-Delivery Report
                @elseif(Request::is('admin/report/today/order/delivered'))
                    Today Completed Orders Report
                @elseif(Request::is('admin/report/today/order/rejected'))
