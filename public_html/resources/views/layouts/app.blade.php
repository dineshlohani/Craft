...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/assets/css/style1.min.css')}}">
    <!-- Tosater css -->
        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="topbar-menu">
                    @guest()
                        <ul>
                            <li><a href="{{ route('login') }}" class="text-white"><i class="fa fa-sign-in"></i>Sign In</a></li>
                            <li><a href="{{ route('login') }}" class="text-white"><i class="fa fa-user-plus"></i>Register</a></li>
                        </ul>
                    @else
                        <ul>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('home') }}"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
                                <a class="dropdown-item" href="{{ route('show.cart') }}"><i class="fas fa-shopping-cart"></i> My Cart</a>
                                <a class="dropdown-item" href="{{ route('show.wishlist') }}"><i class="fas fa-heart"></i> My Wishlist</a>
    ...
    <div class="container">
        <div class="row text-center row-cols-1">
            ...
            <div class="footer1-logo col text-center">
                <img src="{{asset('public/frontend/assets/images/logo/logos.png')}}" alt="">
            </div>
            ...
            <div class="footer1-menu col">
                <ul class="widget-menu justify-content-center">
                    ...
                    <li><a href="{{ route('wholeseller') }}">Wholeseller</a></li>
                    <li><a href="{{route('policies')}}">Policy</a></li>
                    <li><a href="{{route('faq')}}">FAQs</a></li>
                </ul>
            </div>
            <div class="footer1-subscribe d-flex flex-column col">
                <form action="{{ route('store.newsletter') }}" method="POST" class="mc-form widget-subscibe">
                    @csrf
            ...
            <div class="footer1-copyright col">
                <p class="copyright">&copy;{{ date('Y') }} CraftsManNepal Pvt.Ltd. All Rights Reserved | <a href="mailto:info@craftsmannepal.com">info@craftsmannepal.com</a></p>
            </div>
...
<!-- Use the minified version files listed below for better performance and remove the files listed above -->
<script src="{{asset('public/frontend/assets/js/vendor/vendor.min.js')}}"></script>
<script src="{{asset('public/frontend/assets/js/plugins/plugins.min.js')}}"></script>
